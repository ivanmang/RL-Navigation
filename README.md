...
For this project, an agent is trained to collect as many yellow banana as possible in a navigate in a large, square world.  
...
The environment is solved when the agent get an average score of +13 over 100 consecutive episodes.
...
1. Run the code in `Navigation.ipynb` using jupyter notebook to get started.

2. Train the agents

3. A model weights of the successful agent is saved upon training finished.

4. Watch the trained agent collecting bananas!
